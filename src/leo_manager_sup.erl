    ...
    case mnesia:create_schema(Nodes_1) of
        ok ->
            try
                ...
                ok = leo_cluster_tbl_conf:create_table(disc_copies, Nodes_1),
                ok = leo_mdcr_tbl_cluster_info:create_table(disc_copies, Nodes_1),
                ok = leo_mdcr_tbl_cluster_stat:create_table(disc_copies, Nodes_1),
                ok = leo_mdcr_tbl_cluster_mgr:create_table(disc_copies, Nodes_1),
                ok = leo_mdcr_tbl_cluster_member:create_table(disc_copies, Nodes_1),
                ok = leo_cluster_tbl_ring:create_table_current(disc_copies, Nodes_1),
                ok = leo_cluster_tbl_ring:create_table_prev(disc_copies, Nodes_1),
                ok = leo_cluster_tbl_member:create_table(disc_copies, Nodes_1, ?MEMBER_TBL_CUR),
                ok = leo_cluster_tbl_member:create_table(disc_copies, Nodes_1, ?MEMBER_TBL_PREV),
