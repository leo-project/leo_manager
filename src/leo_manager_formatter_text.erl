...
node_stat(?SERVER_TYPE_STORAGE, State) ->
    ...
    MQConf_2 = leo_misc:get_value('mq_num_of_batch_procs', State, []),
    MQConf_3 = leo_misc:get_value('mq_waiting_time_min',   State, []),
    MQConf_4 = leo_misc:get_value('mq_waiting_time_max',   State, []),
    ...
    CompactionConf_2 = leo_misc:get_value('min_compaction_waiting_time',   State),
    CompactionConf_3 = leo_misc:get_value('max_compaction_waiting_time',   State),
    CompactionConf_4 = leo_misc:get_value('step_compaction_waiting_time',  State),
    CompactionConf_5 = leo_misc:get_value('max_compaction_batch_procs',    State),
    CompactionConf_6 = leo_misc:get_value('min_compaction_batch_procs',    State),
    CompactionConf_7 = leo_misc:get_value('step_compaction_batch_procs',   State),
    ...
    io_lib:format(lists:append([
                                ...
                                "          number of batch-procs of msg | ~w\r\n",
                                "     min waiting time/batch-procs (ms) | ~w\r\n",
                                "     max waiting time/batch-procs (ms) | ~w\r\n",
                                "---------------------------------------+------------------\r\n",
                                ...
                                " min interval between batch-procs (ms) | ~w\r\n",
                                " max interval between batch-procs (ms) | ~w\r\n",
                                "                    step interval (ms) | ~w\r\n",
                                "             min number of batch procs | ~w\r\n",
                                "             max number of batch procs | ~w\r\n",
                                "            step number of batch procs | ~w\r\n",
                                "---------------------------------------+------------------\r\n",
                                " Status-1: RING hash\r\n",
                                "---------------------------------------+------------------\r\n",
                                "                     current ring hash | ~s\r\n",
