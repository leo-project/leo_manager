...
node_stat(?SERVER_TYPE_GATEWAY, State) ->
    ...
    io_lib:format(lists:append(["[config-1]\r\n",
                                ...
                                "       [rex] max mem capacity : ~w\r\n",
                                "       [cpu] max cpu load avg : ~w\r\n",
                                "       [cpu] max cpu util     : ~w\r\n",
                                "       [io ] max input size   : ~w\r\n",
                                "       [io ] max output size  : ~w\r\n",
                                "\r\n[status-1: ring]\r\n",
                                "            ring state (cur)  : ~s\r\n",
                                "            ring state (prev) : ~s\r\n",
                                "\r\n[status-2: erlang-vm]\r\n",
                  ...
                  [
                   ...
                   leo_misc:get_value('cpu_max_cpu_util',     WatchdogProps),
                   leo_misc:get_value('io_max_input_for_interval',  WatchdogProps),
                   leo_misc:get_value('io_max_output_for_interval', WatchdogProps),
                   %% status-1 [2]
