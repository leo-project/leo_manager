...
node_stat(?SERVER_TYPE_STORAGE, State) ->
    ...
    io_lib:format(lists:append([
                                ...
                                "        number of batch-procs of msgs | max:~w, min:~w, regular:~w, step:~w\r\n",
                                "   interval between batch-procs (ms)  | max:~w, min:~w, regular:~w, step:~w\r\n",
                                "--------------------------------------+--------------------------------------\r\n",
                                ...
                                "        number of batch-procs of objs | max:~w, min:~w, regular:~w, step:~w\r\n",
                                "   interval between batch-procs (ms)  | max:~w, min:~w, regular:~w, step:~w\r\n",
                                "--------------------------------------+--------------------------------------\r\n",
                                " Status-1: RING hash\r\n",
                                "--------------------------------------+--------------------------------------\r\n",
